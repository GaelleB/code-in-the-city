    ...
    <main className="max-w-7xl mx-auto px-4 py-12 relative">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="typo-h1 font-serif font-bold text-gray-900">
            Playlists
          </h1>
        </div>

        <p className="typo-body text-gray-600 leading-relaxed max-w-3xl italic">
          Chaque playlist contient des morceaux soigneusement selectionnes parmi les bandes originales
          de mes series cultes. Une facon de revivre ces moments magiques, une chanson a la fois.
        </p>
      </motion.div>
